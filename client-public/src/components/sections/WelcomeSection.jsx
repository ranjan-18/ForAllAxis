      ...
      <div className="container">
        ...
        <div className="welcome-grid" style={{ alignItems: 'center' }}>
          ...
          >
            ...
            <h2 className="welcome-title" style={{ fontSize: 'clamp(3rem, 6vw, 4.5rem)', fontWeight: 900, lineHeight: 1.1, marginBottom: '1.5rem', color: 'var(--text-primary)', letterSpacing: '-1px' }}>For<span style={{ color: 'var(--accent-red)' }}>all</span>Axis</h2>
