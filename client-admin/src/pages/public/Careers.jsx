...
export default function Careers() {
  return (
    <>
      <Helmet>
        <title>Careers | Join the ForallAxis Team</title>
        <meta name="description" content="Explore job openings at ForallAxis. We are looking for talented developers, designers, and innovators to build the future of digital tech." />
        <meta property="og:title" content="Careers | Join the ForallAxis Team" />
        <meta property="og:description" content="Explore job openings at ForallAxis. We are looking for talented developers, designers, and innovators to build the future of digital tech." />
      ...
      <section className="section-pad container text-center">
        ...
        <a href={`https://mail.google.com/mail/?view=cm&fs=1&to=${COMPANY_INFO.email}`} target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-lg">Email Resume</a>
      </section>
      </div>
    </>
  );
