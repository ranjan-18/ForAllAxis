...
export default function Dashboard() {
  ...
  const cards = [
    { label: 'Total Projects', value: stats.projects, icon: <FiBriefcase />, link: '/projects', color: '#3b82f6' },
    { label: 'Active Services', value: stats.services, icon: <FiLayers />, link: '/services', color: '#10b981' },
    { label: 'Job Applications', value: stats.applications, icon: <FiFileText />, link: '/applications', color: '#f59e0b' },
    { label: 'Unread Messages', value: stats.contacts, icon: <FiMessageSquare />, link: '/contacts', color: '#ef4444' },
    { label: 'Open Positions', value: stats.careers, icon: <FiTrendingUp />, link: '/careers', color: '#8b5cf6' },
    { label: 'Team Members', value: stats.team, icon: <FiUsers />, link: '/team', color: '#ec4899' },
    { label: 'Client Reviews', value: stats.testimonials, icon: <FiStar />, link: '/testimonials', color: '#06b6d4' }
  ];
