...
export default function ManageCareers() {
  ...
  const [formData, setFormData] = useState({ title: '', type: 'Full-time', location: 'Remote', description: '', department: '' });
  ...
  const handleCancelEdit = () => {
    setFormData({ title: '', type: 'Full-time', location: 'Remote', description: '', department: '' });
    setEditingId(null);
  ...
  return (
    <div>
      ...
      <div><label>Department</label><input className="input-field" value={formData.department} onChange={e => setFormData({...formData, department: e.target.value})} required /></div>
