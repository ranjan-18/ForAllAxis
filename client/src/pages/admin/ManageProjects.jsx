...
export default function ManageProjects() {
  ...
  const [formData, setFormData] = useState({ title: '', shortDescription: '', description: '', category: 'Web Development', link: '', thumbnail: '' });
  ...
  const handleCancelEdit = () => {
    setFormData({ title: '', shortDescription: '', description: '', category: 'Web Development', link: '', thumbnail: '' });
    setEditingId(null);
      ...
      {isFormVisible && (
        <div style={{ 
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div className="grid grid-2" style={{ gap: '1rem' }}>
              <div><label>Live Link</label><input className="input-field" value={formData.link} onChange={e => setFormData({...formData, link: e.target.value})} /></div>
